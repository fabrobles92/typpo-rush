...
const Footer = () => {
  return (
    <footer className="footer footer-center text-base-content rounded p-10 flex-grow-0">
      <nav>
        <div className="grid grid-flow-col gap-4">
          <a href="https://github.com/fabrobles92/typpo-rush">
            <svg
              height="50"
      ...
      <aside>
        <p>Copyright © {new Date().getFullYear()} - Typpo Rush</p>
      </aside>
    </footer>
  );
};
